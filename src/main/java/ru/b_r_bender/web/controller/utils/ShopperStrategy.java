...
public class ShopperStrategy {
    ...
    /**
     * This strategy will allowed to spend only modulus from hero money divided by 25_000 and still more 20% of the rest
    ...
    public static int hundredsOfThousandsSavingShopper(int heroMoney) {
        heroMoney = heroMoney - heroMoney / 25_000 * 25_000;
